...
export const custom_input = function(container_params, input_params, label_params)
{
    if(!container_params)
        container_params = {};
    if(!input_params)
    ...
    else
    {
        ...
        input_params.id    = id; 
        input_params.name  = !!input_params.name ? input_params.name : id;
        input_params.value = !!container_params.value ? container_params.value : input_params.value;
        let label = element('label', label_params);
